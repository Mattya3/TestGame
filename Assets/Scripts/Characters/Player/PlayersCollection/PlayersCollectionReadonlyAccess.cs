...
public class PlayersCollectionReadonlyAccess : AccessComponent<IPlayersCollection>
{
    ...
    private ReadOnlyCollection<Vector3> _emptyPositions = new ReadOnlyCollection<Vector3>(new List<Vector3>());
    private ReadOnlyCollection<Bounds> _emptyBoundsList = new ReadOnlyCollection<Bounds>(new List<Bounds>());
    private ReadOnlyCollection<Vector2> _emptyInputDirections = new ReadOnlyCollection<Vector2>(new List<Vector2>());
